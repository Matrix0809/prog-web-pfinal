const config = {
   apiKey: "AIzaSyBEPd0nGuB5SVtcbA2dat5aLaXOZFe4kWA",
    authDomain: "pfinal-web.firebaseapp.com",
    databaseURL: "https://pfinal-web.firebaseio.com",
    projectId: "pfinal-web",
    storageBucket: "pfinal-web.appspot.com",
    messagingSenderId: "1062404021128",
    appId: "1:1062404021128:web:e8136b531d51bf7982383d"
}
...
const appendEditForm = async() => {
    ...
    submit.setAttribute("value", "Editar Post");
...
if(editButton != null){
    editButton.addEventListener("click", () => {
        if(editMode == false){
            editMode = true;
            console.log("Modo edicion habilitado");
        
            appendEditForm();
        }else{
            editMode = false;
            console.log("Modo edicion deshabilitado");
